...
public final class GameState {
    ...
    public int influence = 82, stability = 74, industry = 68, diplomacy = 55, defense = 61;
    public final List<String> happenings = new ArrayList<>();
    public GameState() {
        happenings.add("Frontier Command established.");
        happenings.add("Vuizcomm regional map synchronized.");
    }
    public void tick() {
        population += Math.max(1000, population / 18000);
        treasury += industry * 120_000.0;
        stability = clamp(stability + (diplomacy > 60 ? 1 : -1));
        influence = clamp(influence + (diplomacy > 65 ? 1 : 0));
    ...
    public String toJson() {
        try {
            ...
            o.put("industry", industry); o.put("diplomacy", diplomacy); o.put("defense", defense);
    ...
    public static GameState fromJson(String json) {
        ...
        try {
            ...
            s.industry=o.optInt("industry",s.industry); s.diplomacy=o.optInt("diplomacy",s.diplomacy); s.defense=o.optInt("defense",s.defense);
